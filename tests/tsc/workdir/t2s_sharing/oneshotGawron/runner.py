...
os.chdir("data")
subprocess.call(tscdefs.get_python_tool("t2s.py",None) + ['--net-file', net, '--modes', '6', '--iteration-dir', iteration_dir, '--tapas-trips', tripFile, '--assignment', 'oneshot+gawron', '-l', '2'])